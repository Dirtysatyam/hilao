...
export default async function retrieveData(query, options = {}) {
  ...
  const request = await got(
    `https://www.analdin.com/search/${query}/?mode=async&function=get_block&block_id=list_videos_videos_list_search_result&q=${query}&category_ids=&sort_by=&from_videos=${
