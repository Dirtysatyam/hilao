...
import { getStarScenes } from "../functions/getStarScenes.js";
...
export default class Client {
  search = async (query, options) => {
    ...
    const v4 = (await getMilf(query, { page })) || [];
    const v5 = (await getAbsolute(query)) || [];
    const videos = [...v1, ...v2, ...v4, ...v3, ...v5];
    return videos;
  };
  ...
  getStarScenes = async (query) => {
    const response = await getStarScenes(query);
    return response;
  };
